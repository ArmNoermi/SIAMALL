                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group {{$errors->has('title') ? 'has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="title" id="title" value="{{old('title')}}" placeholder="Judul Berita">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group {{$errors->has('highlight') ? 'has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="highlight" id="highlight" value="{{old('highlight')}}" placeholder="Tempat Lahir">
