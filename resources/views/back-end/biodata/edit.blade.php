...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ url('/bio-data/'. \Auth::user()->id) . '/update' }}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT')}}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group {{$errors->has('nisn') ? 'has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="nisn" id="nisn" value="{{$biodata->nisn}}" placeholder="NISN">
                                @if($errors->has('nisn'))
                            ...
                            <div class="form-group {{$errors->has('tempat_lahir') ? 'has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" value="{{$biodata->tempat_lahir}}" placeholder="Tempat Lahir">
                            ...
                            <div class="form-group {{$errors->has('tanggal_lahir') ? 'has-error' : ''}}">
                                ...
                                <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="Tanggal Lahir" value="{{$biodata->tanggal_lahir}}">
                            ...
                            <div class="form-group {{$errors->has('agama') ? 'has-error' : ''}}">
                                ...
                                <select class="form-control select2" name="agama" id="agama" style="width: 100%;">
                                    ...
                                    <option value="Kristen" @if($biodata->agama == 'Kristen') selected @endif>Kristen</option>
                                </select>
                                @if($errors->has('agama'))
