...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-warning">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="/calon-siswa/{{$dt->id}}/post-export" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group {{$errors->has('nisn') ? 'has-error' : ''}}">
                                <label for="users">ID User</label>
                                <input type="text" class="form-control" name="users" id="users" value="{{$dt->r_biodata_user->users}}" placeholder="users">
                                @if($errors->has('users'))
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$dt->name}}" name="nama" id="nama" placeholder="Nama Lengkap" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" value="{{$dt->email}}" name="email" id="email" placeholder="Email" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$dt->no_hp}}" name="no_hp" id="no_hp" placeholder="Nomor Handphone" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-warning"> Export <i class="fas fa-arrow-right"></i></button>
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
