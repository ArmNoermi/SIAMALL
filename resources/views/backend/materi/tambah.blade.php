    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="/materi/post-tambah" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="box-body">
                        <div class="form-group {{$errors->has('judul_materi') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{old('judul_materi')}}" type="text" class="form-control" name="judul_materi" id="judul_materi" placeholder="Judul Materi">
