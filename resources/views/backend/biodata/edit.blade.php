    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('bio_data.update', \Auth::user()->id) }}" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->nama_panggilan}}" name="nama_panggilan" type="text" class="form-control" id="nama_panggilan" placeholder="Nama Panggilan">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input value="{{\Auth::user()->no_hp}}" type="text" class="form-control" id="no_hp" placeholder="Nomor Handphone" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group {{$errors->has('nisn') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->nisn}}" type="text" class="form-control" name="nisn" id="nisn" placeholder="NISN">
                                @if($errors->has('nisn'))
                        ...
                        <div class="form-group {{$errors->has('tempat_lahir') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->tempat_lahir}}" type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" placeholder="Tempat Lahir">
                        ...
                        <div class="form-group {{$errors->has('tanggal_lahir') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->tanggal_lahir}}" type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="Tempat Lahir">
                        ...
                        <div class="form-group {{$errors->has('agama') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="agama" id="agama">
                                    <option value="Islam" @if($biodata->agama == 'Islam') selected @endif>Islam</option>
                                    <option value="Kristen Protestan" @if($biodata->agama == 'Kristen Protestan') selected @endif>Kristen Protestan</option>
                                    <option value="Kristen Katolik" @if($biodata->agama == 'Kristen Katolik') selected @endif>Kristen Katolik</option>
                                    <option value="Hindu" @if($biodata->agama == 'Hindu') selected @endif>Hindu</option>
                                    <option value="Budha" @if($biodata->agama == 'Budha') selected @endif>Budha</option>
                                    <option value="Khonghucu" @if($biodata->agama == 'Khonghucu') selected @endif>Khonghucu</option>
                                </select>
                                @if($errors->has('agama'))
                        ...
                        <div class="form-group {{$errors->has('alamat') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="alamat" id="alamat" rows="5" placeholder="Alamat">{{$biodata->alamat}}</textarea>
                        ...
                        <div class="form-group {{$errors->has('asal_sekolah') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->asal_sekolah}}" type="text" class="form-control" name="asal_sekolah" id="asal_sekolah" placeholder="Asal Sekolah">
                        ...
                        <div class="form-group {{$errors->has('alamat_asal_sekolah') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="alamat_asal_sekolah" id="alamat_asal_sekolah" rows="5" placeholder="Alamat Asal Sekolah">{{$biodata->alamat_asal_sekolah}}</textarea>
                        ...
                        <div class="form-group {{$errors->has('anak_ke') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-3">
                                <input value="{{$biodata->anak_ke}}" type="number" class="form-control" name="anak_ke" id="anak_ke" placeholder="Contoh: 1">
                        ...
                        <div class="form-group {{$errors->has('jumlah_saudara') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-3">
                                <input value="{{$biodata->jumlah_saudara}}" type="number" class="form-control" name="jumlah_saudara" id="jumlah_saudara" placeholder="Contoh: 1">
                        ...
                        <div class="form-group {{$errors->has('telp_rumah') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->telp_rumah}}" type="text" class="form-control" name="telp_rumah" id="telp_rumah" placeholder="Telepon Rumah">
                        ...
                        <div class="form-group {{$errors->has('provinsi') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->provinsi}}" type="text" class="form-control" name="provinsi" id="provinsi" placeholder="Provinsi">
                        ...
                        <div class="form-group {{$errors->has('kabupaten') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->kabupaten}}" type="text" class="form-control" name="kabupaten" id="kabupaten" placeholder="Kabupaten">
                        ...
                        <div class="form-group {{$errors->has('kecamatan') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->kecamatan}}" type="text" class="form-control" name="kecamatan" id="kecamatan" placeholder="Kecamatan">
                        ...
                        <div class="form-group {{$errors->has('kode_pos') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$biodata->kode_pos}}" type="text" class="form-control" name="kode_pos" id="kode_pos" placeholder="Kode Pos">
                        ...
                        <div class="form-group {{$errors->has('golongan_darah') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="golongan_darah" id="golongan_darah">
                                    <option value="A" @if($biodata->golongan_darah == 'A') selected @endif>A</option>
                                    <option value="B" @if($biodata->golongan_darah == 'B') selected @endif>B</option>
                                    <option value="O" @if($biodata->golongan_darah == 'O') selected @endif>O</option>
                                    <option value="AB" @if($biodata->golongan_darah == 'AB') selected @endif>AB</option>
                                </select>
                        ...
                        <div class="form-group {{$errors->has('tinggi_badan') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-3">
                                <input value="{{$biodata->tinggi_badan}}" type="number" class="form-control" name="tinggi_badan" id="tinggi_badan" placeholder="Tinggi Badan">
                        ...
                        <div class="form-group {{$errors->has('berat_badan') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-3">
                                <input value="{{$biodata->berat_badan}}" type="number" class="form-control" name="berat_badan" id="berat_badan" placeholder="Berat Badan">
                        ...
                        <div class="form-group {{$errors->has('ket_riwayat_penyakit') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="ket_riwayat_penyakit" id="ket_riwayat_penyakit" rows="5" placeholder="Jelaskan riwayat penyakit anda beserta keterangannya">{{$biodata->ket_riwayat_penyakit}}</textarea>
                        ...
                        <div class="form-group {{$errors->has('status_anak') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="status_anak" id="status_anak">
                                    <option value="1" @if($biodata->status_anak == '1') selected @endif>Yatim dan Piatu</option>
                                    <option value="2" @if($biodata->status_anak == '2') selected @endif>Yatim</option>
                                    <option value="3" @if($biodata->status_anak == '3') selected @endif>Piatu</option>
                                    <option value="4" @if($biodata->status_anak == '4') selected @endif>Keluarga Utuh</option>
                                </select>
                        ...
                        <div class="form-group {{$errors->has('status_orang_tua') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="status_orang_tua" id="status_orang_tua">
                                    <option value="Bersama" @if($biodata->status_orang_tua == 'Bersama') selected @endif>Bersama</option>
                                    <option value="Cerai" @if($biodata->status_orang_tua == 'Cerai') selected @endif>Cerai</option>
                                </select>
                        ...
                        <div class="form-group {{$errors->has('status_asuh') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="status_asuh" id="status_asuh">
                                    <option value="Diasuh ayah dan ibu" @if($biodata->status_asuh == 'Diasuh ayah dan ibu') selected @endif>Diasuh ayah dan ibu</option>
                                    <option value="Diasuh Ayah" @if($biodata->status_asuh == 'Diasuh Ayah') selected @endif>Diasuh Ayah</option>
                                    <option value="Diasuh Ibu" @if($biodata->status_asuh == 'Diasuh Ibu') selected @endif>Diasuh Ibu</option>
                                    <option value="Diasuh Wali" @if($biodata->status_asuh == 'Diasuh Wali') selected @endif>Diasuh Wali</option>
                                </select>
                        ...
                        <div class="form-group {{$errors->has('jurusan_pilihan1') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="jurusan_pilihan1" id="jurusan_pilihan1">
                                    <option value="Agama" @if($biodata->jurusan_pilihan1 == 'Agama') selected @endif>Agama</option>
                                    <option value="IPS" @if($biodata->jurusan_pilihan1 == 'IPS') selected @endif>IPS</option>
                                    <option value="IPA" @if($biodata->jurusan_pilihan1 == 'IPA') selected @endif>IPA</option>
                        ...
                        <div class="form-group {{$errors->has('jurusan_pilihan2') ? 'has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="jurusan_pilihan2" id="jurusan_pilihan2">
                                    <option value="Agama" @if($biodata->jurusan_pilihan2 == 'Agama') selected @endif>Agama</option>
                                    <option value="IPS" @if($biodata->jurusan_pilihan2 == 'IPS') selected @endif>IPS</option>
                                    <option value="IPA" @if($biodata->jurusan_pilihan2 == 'IPA') selected @endif>IPA</option>
